...
def reset():
    ...
    #         # tokenizer.encode("so i hold you in the light , and i wish you curiosity and confidence . and i wish you ethics and enlightenment . i wish you guts . every great decision i have ever made i trusted my gut . and goodness . i wish you purpose and the passion that goes along with that purpose . and here is what i really hope : i hope that every one of you contributes to the conversation of our culture and our time . and to some genuine communication , which means , you have to connect to people exactly where they are ; not where you are , but where they are. and i hope you shake things up . and when the time comes to bet on yourself, i hope you double down . bet on yourself . i hope you always know how happy and how incredibly relieved everybody is in this room is that you have made it to this place , at this time , on this gorgeous day .")
        
    #         tokenizer.encode("so i hold you in the light , and i wish you curiosity and confidence ."),
    #         tokenizer.encode("and i wish you ethics and enlightenment ."),
    #         tokenizer.encode("i wish you guts ."), 
    #         tokenizer.encode("every great decision i have ever made i trusted my gut ."), 
    #         tokenizer.encode("and goodness ."), 
    #         tokenizer.encode("i wish you purpose and the passion that goes along with that purpose ."), 
    #         tokenizer.encode("and here is what i really hope : i hope that every one of you contributes to the conversation of our culture and our time ."),
    #         tokenizer.encode("and to some genuine communication , which means , you have to connect to people exactly where they are ; not where you are , but where they are."),
    #         tokenizer.encode("and i hope you shake things up ."),
    #         tokenizer.encode("and when the time comes to bet on yourself, i hope you double down ."),
    #         tokenizer.encode("bet on yourself ."),
    #         tokenizer.encode("i hope you always know how happy and how incredibly relieved everybody is in this room is that you have made it to this place , at this time , on this gorgeous day .")
    #     ]
    #     # [tokenizer.encode(s) for s in []]
    # print(personality)
    # logger.info("Selected personality: %s", tokenizer.decode(chain(*personality)))
